...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        List<String> directory = Files.readAllLines(Paths.get("C:\\Users\\rock-\\IdeaProjects\\Phone Book\\Phone Book\\task\\src\\directory.txt"));
        List<String> find = Files.readAllLines(Paths.get("C:\\Users\\rock-\\IdeaProjects\\Phone Book\\Phone Book\\task\\src\\find.txt"));
